...
if (isset($_POST['login'])) {
    if(isset($_POST['trainerusername']) && isset($_POST['password'])) {
        $trainerusername = $_POST['trainerusername'];
        $password = $_POST['password'];

        $sql = "SELECT * FROM usertrainer WHERE trainerusername='$trainerusername'";
...
<body>
    ...
    <div class="form-box">
            ...
            <div class="form-content">
                ...
                <form action="#">
                    <div class="input-box">
                    <input type="text" name="trainerusername"  required>
                    ...
                    <button type="button" class="btn" id="trainer-login-btn">เข้าสู่ระบบผู้ออกกำลังกาย</button>
                    <div class="register-link">
                        <p>ไม่มีรหัสสมาชิก <a href="signuptrianer.php">สมัครสมาชิก</a></p>
                    </div>
                </form>
            </div>
        </div>
