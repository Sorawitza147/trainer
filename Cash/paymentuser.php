...
<script>
    // เปิด Modal เมื่อคลิกที่ปุ่มยืนยัน
    ...
    // ส่ง request ไปยัง delete_payment.php เพื่อลบข้อมูล
    function confirmAndClose() {
    // ปิด Modal ก่อนทำการส่ง request
    closeModal();

    // ทำการส่ง request ไปยัง delete_payment.php เพื่อลบข้อมูล
    var xhr = new XMLHttpRequest();
    xhr.onreadystatechange = function() {
        if (xhr.readyState == 4 && xhr.status == 200) {
            // เมื่อลบข้อมูลเสร็จสมบูรณ์ ให้ปิดหน้าต่าง
            window.close();
